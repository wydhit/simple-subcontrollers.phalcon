...
class AliController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $c->appId = env("MONSTER_ALIPAY_APPID");
        $c->rsaPrivateKey = env('MONSTER_ALIPAY_APP_PRIVATE_KEY');
        $c->signType = 'RSA2';
        $c->postCharset='UTF-8';
        $c->format = "json";
        $c->alipayrsaPublicKey = env('MONSTER_ALIPAY_ALI_PUBLIC_KEY');
        $req = new \AlipayTradeWapPayRequest();
        $data['out_trade_no'] = time();
        $data['total_amount'] = 0.01;
        $data['subject'] = 'test';
        $data['seller_id'] = env('MONSTER_ALIPAY_SELLERID');
